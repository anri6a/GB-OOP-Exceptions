package org.example.fromTeacher;
...
public class Program {
     ...
     * @param array
     * @param searchElement
     * @return -1 -> Размерность массива менее трех символов; -2 -> Элемент не найден -3 ->
    ...
    static void task5() {
        ...
        try {
            int[] array = getSumArray(new int[]{1, 3, -4}, new int[]{5, 0, -1});
            for (int e : array) {
